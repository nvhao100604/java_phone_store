...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 12, 2025 at 06:31 AM
...
(8, 'Sony-1000XM4-Gold-A', 5, 2400000.00, 4, 'Sony-1000XM4-Gold-A.jpg', 'Tai nghe Sony chống ồn', 1, 3000000.00),
...
(91, 'Cáp Type C 1m Ugreen 60126', 14, 128000.00, 3, 'Cáp Type C 1m Ugreen 60126.jpg', 'Chức năngrnTruyền dữ liệurnSạcrnĐầu vàornUSB Type-ArnĐầu rarnType C 5V - 3ArnĐộ dài dâyrn1 mrnCông suất tối đarn15 W', 1, 160000.00),
...
(93, 'Cáp Type C - Lightning MFI 1m Ugreen 60759', 14, 152000.00, 3, 'Cáp Type C - Lightning MFI 1m Ugreen 60759.jpg', 'Công nghệTiện íchrnHỗ trợ sạc nhanhrnChức năngrnSạcrnTruyền dữ liệurnĐầu vàornUSB Type-CrnĐầu rarnLightning 60 WrnĐộ dài dâyrn1 mrnCông suất tối đarn60 W', 1, 190000.00),
...
(95, 'Cáp Type C - Type C 1m Ugreen 70427', 14, 200000.00, 3, 'Cáp Type C - Type C 1m Ugreen 70427.jpg', 'Công nghệTiện íchrnChip E-markerrnChức năngrnSạcrnTruyền dữ liệurnĐầu vàornUSB Type-CrnĐầu rarnType C 100 WrnĐộ dài dâyrn1 mrnCông suất tối đarn100 W', 1, 250000.00),
(96, 'Cáp Type C - Type C 1m Ugreen 50997', 14, 104000.00, 3, 'Cáp Type C - Type C 1m Ugreen 50997.jpg', 'Chức năngrnTruyền dữ liệurnSạcrnĐầu vàornUSB Type-CrnĐầu rarnType C 5V - 3A, 9V - 2A, 12V - 3A, 15V - 3A, 20V - 3A (Max 60 W)rnĐộ dài dâyrn1 mrnCông suất tối đarn60 W', 1, 130000.00),
...
ALTER TABLE `donhang`
  ...
  ADD CONSTRAINT `KM-HD` FOREIGN KEY (`MAKHUYENMAI`) REFERENCES `khuyenmai` (`MAKHUYENMAI`) ON DELETE CASCADE ON UPDATE CASCADE,
