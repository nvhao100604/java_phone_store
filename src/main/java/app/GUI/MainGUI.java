...
public class MainGUI extends JFrame {
	...
	public MainGUI() {
		...
		// btnNewButton_11.setIcon(new ImageIcon("src\\main\\resources\\Ảnh\\icon sản
		// phẩm.png"));
		...
		// btnNewButton_10.setIcon(new ImageIcon("src\\main\\resources\\Ảnh\\icon nhà
		// cung cấp.png"));
		...
		// }
		// });
		// btnNewButton_8.setIcon(new ImageIcon("src\\main\\resources\\Ảnh\\icon thống
		// kê.png"));
		...
		// }
		// });
		// btnNewButton_7.setIcon(new ImageIcon("src\\main\\resources\\Ảnh\\icon hóa
		// đơn.png"));
		...
		// lblNewLabel_13.setIcon(new ImageIcon("src\\main\\resources\\Ảnh\\icon tài
		// khoản ( hiển thị ).png"));
		...
		// }
		// });
		// btnNewButton_14.setIcon(new ImageIcon("src\\main\\resources\\Ảnh\\icon tài
		// khoản ( chức năng ).png"));
		...
		// btnPermission.setIcon(new ImageIcon("src\\main\\resources\\Ảnh\\icon phân
		// quyền.png"));
